...
public class ConsultaBeneficioForm extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ConsultarBeneficio
     */
    public ConsultaBeneficioForm() {
        prepararTela();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Tela de Consulta de Beneficio");
        setExtendedState(6);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try {
            Beneficio beneficioSelecionado = beneficios.get(linhaSelecionada);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaBeneficioForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaBeneficioForm().setVisible(true);
            }
        });
    }
    ...
    private class ModeloTabelaAluno extends AbstractTableModel {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            Beneficio beneficio = beneficios.get(rowIndex);
            if (columnIndex == 0) {
                return beneficio.getNome();
